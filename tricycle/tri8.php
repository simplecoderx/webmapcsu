...
<head>
    ...
    <title>Driver 8 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Garry Montecalo</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>888-888-888</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>8:00 A.M. - 6:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639567433348</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Kabisado ko na halos mga establishments sa loob ng CSU, kaya kitang e-tour kung saan mo man gusto.</p>
          </div>
        </div>
      </div>
    </div>
