...
<head>
    ...
    <title>Driver 13 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Ian Raplh Mateo</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>113-113-113</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>9:00 A.M. - 9:00 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639875644453</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Nais ko lang matulungan ang aking pamilya sa pamamagitan po ng pamamasada.</p>
          </div>
        </div>
      </div>
    </div>
