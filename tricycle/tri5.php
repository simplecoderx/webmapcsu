...
<head>
    ...
    <title>Driver 5 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Rian Asunta</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>555-555-555</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>6:00 A.M. - 7:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639074568891</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              <tr>
                ...
                <td width="2%">:</td>
                <td>Driver since 2012 - Present</td>
              </tr>
              <tr>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Dahil sa pamamasada ay nakapagtapos po ang aking anak sa kursong medisina at hindi ko ikinakahiya itong aking marangal na pagtatrabaho.</p>
          </div>
        </div>
      </div>
    </div>
