...
<head>
    ...
    <title>Driver 11 | WebMapCSU</title>
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>110-110-110</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>7:00 A.M. - 7:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639876900056</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Isang tawag mo lang, papunta na ako. Nais kong matulungan ang aking pamilya sa pamamagitan ng aking pamamasada.</p>
          </div>
        </div>
      </div>
    </div>
