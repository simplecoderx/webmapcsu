...
<head>
    ...
    <title>Driver 17 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Ranz Samaranos</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>117-117-117</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>7:00 A.M. - 7:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639123211123</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Kung nais mong malibot ang buong unibersidad, 'wag mahiyang tumawag po sa akin at bibigyan kita ng magandang storya hinggil sa mga establishments patungkol sa paaralan.</p>
          </div>
        </div>
      </div>
    </div>
