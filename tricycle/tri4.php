...
<head>
    ...
    <title>Driver 4 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Benedict Atenta</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>444-444-444</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>7:00 A.M. - 7:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+63912345678</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              <tr>
                ...
                <td width="2%">:</td>
                <td>Driver since 2014 - Present</td>
              </tr>
              <tr>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Don't worry. I can take you to your destination safely.</p>
          </div>
        </div>
      </div>
    </div>
