...
<head>
    ...
    <title>Driver 1 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. John Kyle Padilla</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>111-111-111</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>7:00 A.M. - 7:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639268433347</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>I've been driving so long and it's my job to get you to your destination safe and sound. Don't hesitate to call me cause i'll be there.</p>
          </div>
        </div>
      </div>
    </div>
