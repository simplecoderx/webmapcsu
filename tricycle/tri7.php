...
<head>
    ...
    <title>Driver 7 | WebMapCSU</title>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3>Mr. Randy Santiago</h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Drivers' ID:</strong>777-777-777</p>
            <p class="mb-0"><strong class="pr-1">Schedule:</strong>6:00 A.M. - 6:30 P.M.</p>
            <p class="mb-0"><strong class="pr-1">Contact Number:</strong>+639084569987</p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              <tr>
                ...
                <td width="2%">:</td>
                <td>Driver since 2009 - Present</td>
              </tr>
              <tr>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
              <p>Matagal na po akong nagseserbosyo sa CSU as tricycle driver po at madami narin akong natulungan dahil sa aking tricycle.</p>
          </div>
        </div>
      </div>
    </div>
